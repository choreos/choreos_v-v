...
public class ResponseParserTest {
	...
	public void shouldParseASimpleXml() throws ParserConfigurationException, SAXException {
		...
		ResponseItem expected = new ResponseItemImpl("search_by_brandResult");
		ResponseItem child = new ResponseItemImpl("name");
	...
	public void shouldParseAComplexTypeTest() throws ParserConfigurationException, SAXException{
		...
		ResponseItem expected = new ResponseItemImpl("search_by_categoryResult");

		ResponseItem item = new ResponseItemImpl("Item");

		ResponseItem childA = new ResponseItemImpl("category");
		childA.setContent("mouse");
		item.addChild(childA);

		ResponseItem childB = new ResponseItemImpl("price");
		childB.setContent("89.2");
		item.addChild(childB);

		ResponseItem childC = new ResponseItemImpl("model");
		childC.setContent("RZG145");
		item.addChild(childC);

		ResponseItem childD = new ResponseItemImpl("brand");
	...
	public void shouldPaseComplexTypeListWithEmptySpaces() throws ParserConfigurationException, SAXException{
		...
		ResponseItem item1 = new ResponseItemImpl("Item");
		ResponseItem childA = new ResponseItemImpl("category");
		childA.setContent("mouse");
		...
		ResponseItem item2 = new ResponseItemImpl("Item");
		...
		ResponseItem item3 = new ResponseItemImpl("Item");
		childA = new ResponseItemImpl("category");
		childA.setContent("mouse");
