...
@XmlRootElement(name = "searchByArtistResponse", namespace = "http://storews.vvws.choreos.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchByArtistResponse", namespace = "http://storews.vvws.choreos.eu/")
