...
@XmlRootElement(name = "searchByGenreResponse", namespace = "http://storews.vvws.choreos.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchByGenreResponse", namespace = "http://storews.vvws.choreos.eu/")
